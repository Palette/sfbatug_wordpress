        ...
        <div class="wrap">
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <div class="bp-profile-menu-sort">
                    ...
                    <ul id="SP_BPCPM_sortable" class="ui-sortable" style="width:360px;">
                        <?php
                            global $bp;
                        ...
                        else
                        {
                            ?>
                                <div style="background-color: lightYellow; border-color: #E6DB55; margin: 15px 0 15px; padding: 0.8em; -webkit-border-radius: 3px; border-radius: 3px; border-width: 1px; border-style: solid; width:700px;">
                                     <strong>Love our plugin?</strong> If you like this plugin and would like to see more free features and bug fixes added, please help support us by leaving a small <a href="http://sensibleplugins.com/donate" target="_blank"><strong>donation</strong></a>. Every dollar will make a difference.
                                </div>
                            <div style="background-color: lightYellow; border-color: #E6DB55; margin: 15px 0 15px; padding: 0.8em; -webkit-border-radius: 3px; border-radius: 3px; border-width: 1px; border-style: solid; width:700px;">
                                     <strong>Want more control?</strong> If you'd like to visually reorder the tabs, or get more features such as sub-tabs, public tabs, or iframe tabs, make sure to grab yourself a copy of the <strong>Pro</strong> version from <a href="http://sensibleplugins.com" target="_blank"><strong>Sensible Plugins</strong></a>.
                                </div>
                            <?php
                        }
                    ?>
